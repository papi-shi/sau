...
function initializeDatabase() {
    ...
    $create_table = "CREATE TABLE IF NOT EXISTS `incidents` (
        ...
        `substation` VARCHAR(50) DEFAULT 'RIOHONDO',  -- NEW FIELD ADDED
...
<body>
    ...
    <nav>
        <ul>
            <li><a href="RIOHONDOview.php"><i class="fas fa-home"></i> Home</a></li>
            <li><a href="RIOHONDOview.php" id="monthly-report-btn"><i class="fas fa-calendar-alt"></i> Monthly Report</a></li>
            <li><a href="RIOHONDOview.php" id="quarterly-report-btn"><i class="fas fa-chart-bar"></i> Quarterly Report</a></li>
            <li><a href="RIOHONDOview.php" id="yearly-report-btn"><i class="fas fa-chart-line"></i> Yearly Report</a></li>
        </ul>
    </nav>
...
function showReportSelectionModal(reportType) {
    ...
    const html = `
        ...
        <form action="RIOHONDOview.php" method="get">
