...
function getTotalWorth($substation = 'malangas') {
    $conn = connectDB();
...
<!-- [Rest of your HTML remains the same] -->
 <body>
    ...
    <nav>
        <ul>
            <li><a href="malangas.php"><i class="fas fa-home"></i> Home</a></li>
            <li><a href="malangas.php" id="add-incident-btn"><i class="fas fa-plus-circle"></i> Add Incident</a></li>
            <li><a href="malangas.php" id="monthly-report-btn"><i class="fas fa-calendar-alt"></i> Monthly Report</a></li>
            <li><a href="malangas.php" id="quarterly-report-btn"><i class="fas fa-chart-bar"></i> Quarterly Report</a></li>
            <li><a href="malangas.php" id="yearly-report-btn"><i class="fas fa-chart-line"></i> Yearly Report</a></li>
        </ul>
    </nav>
                     ...
                     <div class="substation-highlight">
                        <div class="form-group">
                            ...
                            <select name="substation" id="substation" required>
                                <option value="malangas" selected>malangas</option>
                            </select>
                        </div>
                    </div>
...
function showReportSelectionModal(reportType) {
    ...
    const html = `
        ...
        <form action="malangas.php" method="get">
