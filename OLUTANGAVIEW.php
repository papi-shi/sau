...
<body>
    ...
    <nav>
        <ul>
            <li><a href="OLUTANGAview.php"><i class="fas fa-home"></i> Home</a></li>
            <li><a href="OLUTANGAview.php" id="monthly-report-btn"><i class="fas fa-calendar-alt"></i> Monthly Report</a></li>
            <li><a href="OLUTANGAview.php" id="quarterly-report-btn"><i class="fas fa-chart-bar"></i> Quarterly Report</a></li>
            <li><a href="OLUTANGAview.php" id="yearly-report-btn"><i class="fas fa-chart-line"></i> Yearly Report</a></li>
        </ul>
    </nav>
...
function showReportSelectionModal(reportType) {
    ...
    const html = `
        ...
        <form action="OLUTANGAview.php" method="get">
