...
<body>
    ...
    <nav>
        <ul>
            <li><a href="KABASALANview.php"><i class="fas fa-home"></i> Home</a></li>
            <li><a href="KABASALANview.php" id="monthly-report-btn"><i class="fas fa-calendar-alt"></i> Monthly Report</a></li>
            <li><a href="KABASALANview.php" id="quarterly-report-btn"><i class="fas fa-chart-bar"></i> Quarterly Report</a></li>
            <li><a href="KABASALANview.php" id="yearly-report-btn"><i class="fas fa-chart-line"></i> Yearly Report</a></li>
        </ul>
    </nav>
...
function showReportSelectionModal(reportType) {
    ...
    const html = `
        ...
        <form action="KABASALANview.php" method="get">
